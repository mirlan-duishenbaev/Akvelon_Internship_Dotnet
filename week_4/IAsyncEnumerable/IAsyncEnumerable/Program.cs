...
namespace GitHubActivityReport
{
    ...
    class Program
    {
        ...
        static async Task Main(string[] args)
        {
            ...
            try
            {
                ...
                await foreach(var result in results)
                {
                    ...
                    Console.WriteLine("Created at: {0}", result.CreatedAt);
                }
            }
        ...
        private static async IAsyncEnumerable<Issue> RunPagedQueryAsync(GitHubClient client, string queryText, string repoName, CancellationToken cancel, IProgress<int> progress)
        {
